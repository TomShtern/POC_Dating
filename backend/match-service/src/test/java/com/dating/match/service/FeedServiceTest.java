...
class FeedServiceTest {
        ...
        void getFeed_Success() {
                ...
                RecommendationServiceClient.RecommendationsResponse recommendations = new RecommendationServiceClient.RecommendationsResponse(
                                List.of(
        ...
        void getFeed_Empty() {
                ...
                RecommendationServiceClient.RecommendationsResponse emptyRecommendations = new RecommendationServiceClient.RecommendationsResponse(
                                List.of(), 0, false);
